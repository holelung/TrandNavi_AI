...
class Cart(Base):
    ...
    def __init__(self, product_name, product_detail, product_img, price):
    ...
    def __repr__(self) -> str:
        return f"<Cart(id={self.id!r}, user_id={self.user_id!r}, product_name={self.product_name!r}, product_detail={self.product_detail!r}, product_img={self.product_img}, price={self.price!r})>"
